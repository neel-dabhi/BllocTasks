...
public class CustomSwitchCompact extends CompoundButton {
    ...
    private static final Property<CustomSwitchCompact, Float> THUMB_POS =
            new Property<CustomSwitchCompact, Float>(Float.class, "thumbPos") {
                @Override
                public Float get(CustomSwitchCompact object) {
                    return object.mThumbPosition;
                }

                @Override
                public void set(CustomSwitchCompact object, Float value) {
    ...
    public CustomSwitchCompact(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        final TintTypedArray a = TintTypedArray.obtainStyledAttributes(context,
                attrs, androidx.appcompat.R.styleable.SwitchCompat, defStyleAttr, 0);
        mThumbDrawable = a.getDrawable(androidx.appcompat.R.styleable.SwitchCompat_android_thumb);
        if (mThumbDrawable != null) {
            mThumbDrawable.setCallback(this);
        }
        mTrackDrawable = a.getDrawable(androidx.appcompat.R.styleable.SwitchCompat_track);
        if (mTrackDrawable != null) {
            mTrackDrawable.setCallback(this);
        }
        mTextOn = a.getText(androidx.appcompat.R.styleable.SwitchCompat_android_textOn);
        mTextOff = a.getText(androidx.appcompat.R.styleable.SwitchCompat_android_textOff);
        mShowText = a.getBoolean(androidx.appcompat.R.styleable.SwitchCompat_showText, true);
        mThumbTextPadding = a.getDimensionPixelSize(
                androidx.appcompat.R.styleable.SwitchCompat_thumbTextPadding, 0);
        mSwitchMinWidth = a.getDimensionPixelSize(
                androidx.appcompat.R.styleable.SwitchCompat_switchMinWidth, 0);
        mSwitchPadding = a.getDimensionPixelSize(
                androidx.appcompat.R.styleable.SwitchCompat_switchPadding, 0);
        mSplitTrack = a.getBoolean(androidx.appcompat.R.styleable.SwitchCompat_splitTrack, false);
        ...
        PorterDuff.Mode thumbTintMode = DrawableUtils.parseTintMode(
                a.getInt(androidx.appcompat.R.styleable.SwitchCompat_thumbTintMode, -1), null);
        ...
        PorterDuff.Mode trackTintMode = DrawableUtils.parseTintMode(
                a.getInt(androidx.appcompat.R.styleable.SwitchCompat_trackTintMode, -1), null);
        ...
        final int appearance = a.getResourceId(
                androidx.appcompat.R.styleable.SwitchCompat_switchTextAppearance, 0);
        if (appearance != 0) {
...
//        mTextHelper.loadFromAttributes(attrs, defStyleAttr);
    ...
    public void setSwitchTextAppearance(Context context, int resid) {
        ...
        colors = appearance.getColorStateList(androidx.appcompat.R.styleable.TextAppearance_android_textColor);
        if (colors != null) {
            mTextColors = colors;
        } else {
        ...
        ts = appearance.getDimensionPixelSize(androidx.appcompat.R.styleable.TextAppearance_android_textSize, 0);
        if (ts != 0) {
        ...
        typefaceIndex = appearance.getInt(androidx.appcompat.R.styleable.TextAppearance_android_typeface, -1);
        styleIndex = appearance.getInt(androidx.appcompat.R.styleable.TextAppearance_android_textStyle, -1);
    ...
    private void animateThumbToCheckedState(final boolean newCheckedState) {
        ...
        mPositionAnimator.setInterpolator(new LinearOutSlowInInterpolator());
        ...
        mPositionAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                interpolation = newCheckedState ? 1 - valueAnimator.getAnimatedFraction() :  valueAnimator.getAnimatedFraction();
                mTrackDrawable.setAlpha((int) (255 *  Math.max(0.3,interpolation)));
            }
        });
